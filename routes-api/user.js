...
function userApi (apiRouter) {
  ...
  apiRouter.put('/user/password-reset/:jotToken', // use as a setter after the post-user-forgot-password
    ...
    handlers.user.updateUserPasswordReset.findUser,
  ...
  apiRouter.get('/user/:userId/company',
    lib.params,
    handlers.user.getUserCompany.logic,
    handlers.user.getUserCompany.response);

  apiRouter.post('/user/:userId/company',
    lib.params,
    handlers.user.postUserCompany.validateParams,
    handlers.user.postUserCompany.logic,
    handlers.user.postUserCompany.response);

  apiRouter.delete('/user/:id/company',
    lib.params,
    handlers.user.removeUserCompany.validateParams,
    handlers.user.removeUserCompany.logic,
    handlers.user.removeUserCompany.response);

    apiRouter.get('/users/:userId/company',
    lib.params,
    handlers.user.getUsersCompany.logic,
    handlers.user.getUsersCompany.response);

    apiRouter.post('/user/verify-connection/:jotToken',
    lib.params,
    lib.isTokenExist.user,
    handlers.user.verifyConnection.logic);
