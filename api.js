...
routesApi.job(apiRouter);

routesApi.scholarship(apiRouter);

routesApi.campusAdmin(apiRouter);

routesApi.blog(apiRouter);

routesApi.company(apiRouter);
