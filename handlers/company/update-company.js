...
function validateParams(req, res, next) {
    ...
    bodySchema = {
        ...
        recruit: {
            ...
            isInt: {
                errorMessage: 'Invalid Resource: Recruit'
            }
        },
        industry: {
            optional: true
...
function updateCompany(req, res, next) {
    ...
    return req.db.company.update({
        ...
        .catch(error => {
            ...
            req.log.error({
                err: error.message
            }, 'company.create Error - update-company');
        });
}
...
function saveAttachments (req, res, next) {
    ...
    .catch(error => {
      ...
      req.log.error({
        err: error.message
      }, 'attachment.bulkCreate Error - update-company');
    });
  }
...
module.exports.logic = updateCompany;
