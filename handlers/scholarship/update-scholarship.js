...
function validateParams(req, res, next) {
    ...
    bodySchema = {
        ...
        eligibility_requirements: {
            notEmpty: {
                errorMessage: 'Missing Resource: Eligibility Requirements'
            }
        },
        benefits: {
            notEmpty: {
                errorMessage: 'Missing Resource: Benefits'
            }
        },
        deadline: {
            optional: true
...
function updateScholarship(req, res, next) {
    ...
    return req.db.scholarship.update({
        userId: user.id,
        title: title,
        details: details,
        country: country,
        ...
        .catch(error => {
            ...
            req.log.error({
                err: error.message
            }, 'scholarship.create Error - update-scholarship');
        });
}
...
module.exports.logic = updateScholarship;
