...
function validateParams (req, res, next) {
  let bodySchema = {
    ...
    secret: {
      notEmpty: {
        errorMessage: 'Missing Resource: Secret Token'
      }
    }
  };
...
function updateUserPasswordReset (req, res, next) {// eslint-disable-line id-length
...
module.exports.logic = updateUserPasswordReset;
