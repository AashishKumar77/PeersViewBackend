...
function saveAttachments (req, res, next) {
  let postReply = req.$scope.userCredits;
  ...
  .then(attachments => {
    postReply.dataValues.attachments = attachments;
    req.$scope.attachments = attachments;
    req.$scope.postReply = postReply;
    next();
    return attachments;
  })
  .catch(error => {
...
const response = (req, res) => {
  let body = {
    ...
    data: {
      ...
      attachments: req.$scope.attachments
    }
  };
